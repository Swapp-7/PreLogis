...
class ResidentsExport implements FromCollection, WithHeadings, WithMapping, WithStyles, WithTitle, ShouldAutoSize, WithEvents
{
    protected $query;
    ...
    public function collection()
    {
        ...
        return Resident::with(['chambre', 'parents'])->get();
    }
    ...
    public function map($resident): array
    {
        ...
        return [
            ...
            $resident->PRENOMRESIDENT,
            $resident->MAILRESIDENT,
            $resident->TELRESIDENT,
            $resident->DATENAISSANCE,
            $resident->ETABLISSEMENT,
            $resident->ANNEEETUDE,
            $resident->NATIONALITE,
            $resident->adresse->ADRESSE,
            $resident->adresse->CODEPOSTAL,
            $resident->adresse->VILLE,
            $resident->adresse->PAYS,
            ...
            $resident->DATEDEPART ?? 'Non définie'
        ];
    }
