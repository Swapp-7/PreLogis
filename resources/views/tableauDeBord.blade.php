...
<div class="dashboard-container">
    ...
    <div class="movements-section">
        ...
        @php
            ...
            $arrivees = \App\Models\Resident::whereBetween('DATEINSCRIPTION', [$startOfWeek->format('Y-m-d'), $endOfWeek->format('Y-m-d')])
                                          ->orderBy('DATEINSCRIPTION')
                                          ->take(5)
                                          ->get();
            
            // Récupérer les départs de la semaine
            $departs = \App\Models\Resident::whereBetween('DATEDEPART', [$startOfWeek->format('Y-m-d'), $endOfWeek->format('Y-m-d')])
                                         ->orderBy('DATEDEPART')
                                         ->take(5)
                                         ->get();
        @endphp
